...
const RedeemID = ({ params }: { params: Promise<{ end: string; username: string; password: string, id: string }> }) => {
    const { end, username, password, id } = React.use(params);
                ...
                <div className='flex gap-12'>
                    ...
                    <div className='bg-[#802834] rounded-md'>
                        <div className='text-white p-5'>
                            <h1 className='text-xl font-bold text-center'>ชื่อเครื่อง : {id}</h1>
